...
const defaultColors = ['#7F6F94', '#3B4E86', '#225BE8', '#B9D5E3', '#676388'];
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      dispose() {
        ...
        // Remove container-level event listeners
      ...
      setCoords(x: number, y: number) {
        ...
        console.log('Mouse coords:', this.coords.x, this.coords.y);
      ...
      onDocumentMouseMove(event: MouseEvent) {
        ...
        this.hasUserControl = true;
        this.isAutoActive = false; // Stop auto mode when user moves mouse
      }
      ...
      update() {
        ...
        // Only apply auto intensity if auto is active and no user control
        if (this.isAutoActive && !this.takeoverActive && !this.hasUserControl) {
...
`;
    ...
    if (isInitializedRef.current && webglRef.current && !contextLostRef.current) {
      return;
    }
