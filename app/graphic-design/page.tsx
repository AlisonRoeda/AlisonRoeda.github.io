                ...
                {group.images.map((image, imageIndex) => (
                  ...
                  >
                    <Image
                      ...
                      className={`${group.originalLayout ? 'w-full h-auto' : (group.fixedHeight ? 'w-full h-64 object-contain' : (group.sameHeight ? 'w-full h-64 object-contain' : (group.biggerSize ? 'w-full h-80 object-contain' : 'w-48 h-48 object-contain')))} rounded-lg shadow-lg hover:shadow-xl transition-shadow`}
                      loading="lazy"
