...
export default function Projects() {
  ...
  return (
    <div className={`min-h-screen p-8 relative ${isLightMode ? 'bg-gray-50' : 'bg-black'}`}>
      {/* LiquidEther Background - only show in dark mode */}
      {!isLightMode && (
        <div 
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className={`text-2xl font-bold mb-3 ${isLightMode ? 'text-black' : 'text-white'}`}>
                  {project.title}
                </h3>
                
                <p className={`mb-4 leading-relaxed ${isLightMode ? 'text-gray-600' : 'text-gray-400'}`}>
                  {project.description}
                </p>
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className={`inline-flex items-center justify-center flex-1 px-6 py-3 font-semibold text-sm uppercase tracking-wider transition-all duration-300 rounded-lg border cursor-pointer ${
                      isLightMode 
                  ...
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`inline-flex items-center justify-center px-4 py-3 font-semibold text-sm uppercase tracking-wider transition-all duration-300 rounded-lg border cursor-pointer ${
                        isLightMode 
